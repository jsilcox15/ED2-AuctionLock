...
const RegisterForm = () => { 
  ...
  //should I put this in the sign in page?
  //Then when there is an authorization should I hide the button?
    ...
    <Layout>
        <div className="login-form">
            ...
            <form className="App">
                ...
                />
                <br></br>
                {showButton && <input type="Submit" value="Register" className="login-btn" onClick={handleSubmit} />}
            </form>
            </div>
        </div>
    </Layout>
